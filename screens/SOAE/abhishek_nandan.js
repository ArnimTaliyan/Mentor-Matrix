...
const Abhishek_nandan = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/dr-abhishek-nandan-2b995669');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:anandan@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/abhishek_nandan.png')}  style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Dr. Abhishek Nandan</Text>
...
export default Abhishek_nandan;
