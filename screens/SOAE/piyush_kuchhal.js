...
const Piyush_kuchhal = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/piyush-kuchhal-03ab241a5');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:pkuchhal@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/piyush_kuchhal.png')}  style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Piyush Kuchhal</Text>
            <Text style={{ fontSize: 14, color: 'grey' }}>Cluster Head</Text>
...
Prof. Piyush has made significant contributions to academia and research. He actively participates in conferences, delivering invited lectures and organizing events in his area of expertise. He has successfully supervised numerous PhD and B.Tech./M. Tech. dissertations, shaping the next generation of scholars. Proficient in MATLAB, COMSOL Multiphysics, HFSS, and PV Sys, he leverages his technical skills to advance research and development. Overall, his profile showcases his dedication to education, research, and leadership, making him a highly respected and accomplished professional in his field.              </Text>
            </TouchableOpacity>
          ) : (
            <TouchableOpacity onPress={toggleExpandSummary} style={styles.summaryContainer}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
