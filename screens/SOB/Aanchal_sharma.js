...
const Aanchal_sharma = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/aanchalsharma10');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:anchal.sharma@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/Aanchal_sharma.png')} resizeMode='contain' style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Aanchal Sharma</Text>
