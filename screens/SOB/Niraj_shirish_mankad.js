...
const Niraj_shirish_mankad = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/neerajmankad');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:niraj.mankad@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/Niraj_shirish_mankad.png')} resizeMode='contain' style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Dr. Niraj Shirish Mankad</Text>
            <Text style={{ fontSize: 14, color: 'grey' }}>Professor and Associate Dean</Text>
...
Niraj has published book chapters and several articles in his area and lectured on technology, strategy and digital capabilities in several industry and academic forums, both in India and abroad.</Text>
            </TouchableOpacity>
          ) : (
            <TouchableOpacity onPress={toggleExpandSummary} style={styles.summaryContainer}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
...
export default Niraj_shirish_mankad;
