...
const Alind = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/alindnasra');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:alind@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/Alind.png')}  style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Alind Nasra</Text>
  ...
  <Text style={{ fontSize: 14, marginLeft: 4, color: 'grey' }}>LinkedIn</Text>
          ...
          {isExpandedSummary ? (
            <TouchableOpacity onPress={toggleExpandSummary} style={styles.summaryContainer}>
              ...
              Alind received his M.Tech degree in 2015 from Indian Institute of Technology Delhi and B.Tech degree in 2012 from Uttar Pradesh Technical University, Lucknow. He is currently pursuing his PhD Degree from the University of Petroleum and Energy Studies, Dehradun. He has more than 5 years of experience in academics and research. His research interest lies in Optimizations, Game Design and Development.
