...
const Dhirendra_kumar_sharma = ({ navigation }) => {
  const handleEmailPress = () => {
    Linking.openURL('https://in.linkedin.com/in/dhirendra-kumar-sharma-2316b316');
  };
  const handleGetInTouchPress = () => {
    Linking.openURL('mailto:dk.sharma@ddn.upes.ac.in');
  };
      ...
      <View style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Image source={require('../../assets/images/Dhirendra_kumar_sharma.png')}  style={{ height: 190, width: 190, borderRadius: 999, borderColor: '#242760', borderWidth: 2, marginTop: -120 }} />
            <Text style={{ fontSize: 26, color: '#242760', marginVertical: 8 }}>Dhirendra Kumar Sharma</Text>
...
export default Dhirendra_kumar_sharma;
